package com.dicoding.film.core.data.source.local

import com.dicoding.film.core.data.source.local.entity.FilmEntity
import com.dicoding.film.core.data.source.local.room.FilmDao
...
class LocalDataSource(private val mFilmDao: FilmDao) {
    ...
    fun getDetailFilm(filmId: Int): Flow<FilmEntity> =
        mFilmDao.getDetail(filmId)



    suspend fun insertFilm(films: List<FilmEntity>) = mFilmDao.insertFilm(films)
